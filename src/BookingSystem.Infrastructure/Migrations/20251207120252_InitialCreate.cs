    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "Code", "IsActive", "Name", "TimeZone" },
                values: new object[,]
                {
                    { 1, "SG", true, "Singapore", "Asia/Singapore" },
                    { 2, "MY", true, "Malaysia", "Asia/Kuala_Lumpur" },
                    { 3, "TH", true, "Thailand", "Asia/Bangkok" },
                    { 4, "US", true, "United States", "America/New_York" }
                });
